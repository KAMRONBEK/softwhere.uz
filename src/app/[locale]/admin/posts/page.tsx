                ...
                <div className="grid lg:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <AdminSelect
                      ...
                      onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setGenerationForm({...generationForm, category: e.target.value})}
                    ...
                    <AdminInput
                      ...
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) => setGenerationForm({...generationForm, customTopic: e.target.value})}
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        {['en', 'ru', 'uz'].map((locale) => (
                          <label key={locale} className="flex items-center p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                            <input
                              type="checkbox"
          ...
          <div className="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-sm text-gray-600">{posts.length} total posts in {postGroups.length} groups</p>
              </div>
