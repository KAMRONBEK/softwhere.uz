export default function BlogPostLoading() {
  return (
    <div className='page-layout min-h-screen' style={{ backgroundColor: 'var(--gray-100)' }}>
      ...
      <div className='w-full h-64 md:h-96 bg-gray-200 dark:bg-gray-700 animate-pulse' />
      <main className='container py-12'>
        <div className='bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden'>
          <div className='p-8 md:p-12 space-y-6'>
            <div className='text-center space-y-4'>
              <div className='h-10 bg-gray-200 dark:bg-gray-700 rounded w-3/4 mx-auto animate-pulse' />
